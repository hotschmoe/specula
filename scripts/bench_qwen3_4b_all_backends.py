...
PROMPT_DIR = REPO_ROOT / "results" / "qwen3_4b_baseline"
...
def format_md_table(rows: list[dict], power_state: str, tag: str) -> str:
    ...
    docs/qwen3_4b_baseline_all_backends.md. Paste this into the doc's
...
def main() -> int:
    ...
    log_dir = TRASH_ROOT / f"qwen3_4b_baseline_{tag}"
    ...
    csv_path = CSV_DIR / f"qwen3_4b_baseline_{tag}.csv"
    ...
    print(f"paste table above into docs/qwen3_4b_baseline_all_backends.md when promoting this run")
    return 0
